...
// calculates the sum of all the n (sequence lengths) in each triplet
int sumOfN(int *triplets, int length) {
    int sum = 0;
    int i;
...
// prints the fibonacci sequence for each triplet
// prints the distinct values from all sequences
void printFibonacciSequences(int* triplets, int length) {
    ...
    for(i = 0; i < length; i+=3) {
        ...
        // so, one we compute a fibonacci sequence, we check if each value occurs already
